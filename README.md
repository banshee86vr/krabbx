...
**Perfect for testing and development!** See our [Local Setup Guide](docs/LOCAL_SETUP.md) for a detailed walkthrough.
...
2. **Configure environment**
   ...
   - `GITHUB_AUTH_CLIENT_SECRET` - OAuth App Secret
   - `SESSION_SECRET` - Random string (32+ characters)
   - `STORAGE_MODE=memory` - Use in-memory storage (no database!)
...
### 🗄️ Production Setup with Database
...
1. **Configure database**
   ...
   DATABASE_URL=postgresql://user:password@localhost:5432/renovate_dashboard
   ```
